...
@Unremovable
@ApplicationScoped
public class MedicaoAuthorityContextProvider implements AuthorityContextProvider<Long> {

    @Inject
    private ContratosBC contratoBC;

    @Override
    public ResourceAuthorityContext get(Long idMedicao) {

        ContratoBD contratoMedicao = contratoBC.consultarContratoAssociadoMedicao(idMedicao);
