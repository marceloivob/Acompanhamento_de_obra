...
@Unremovable
@ApplicationScoped
public class ParalisacaoAuthorityContextProvider implements AuthorityContextProvider<Long> {

    @Inject
    private ContratosBC contratoBC;

    @Override
    public ResourceAuthorityContext get(Long idParalisacao) {

        ContratoBD contratoMedicao = contratoBC
                .consultarContratoAssociadoParalisacao(idParalisacao);
        ...
        throw new MedicaoRestException(MessageKey.ERRO_PARALISACAO_OBRA_INEXISTENTE,
