...
@Unremovable
@ApplicationScoped
public class ContratoRespTecnicoAuthorityContextProvider implements AuthorityContextProvider<Long> {

    @Inject
    private ContratosBC contratoBC;

    @Override
    public ResourceAuthorityContext get(Long idContratoRespTec) {

        ContratoBD contratoMedicao = contratoBC.consultarContratoAssociadoContratoRespTecnico(idContratoRespTec);
        ...
        throw new MedicaoRestException(MessageKey.CONTRATO_RESP_TEC_INEXISTENTE, Status.NOT_FOUND.getStatusCode());
    }
}
